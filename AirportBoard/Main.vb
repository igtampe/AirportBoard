...
Module Main
    ...
    Public Sub Main()
        ...
        Console.Clear()
        Console.Title = "AirportBoard [Version 1.1]"
    ...
    Public Sub Run(File As String)
        ...
        'Get page contents
        Dim PageContents() As String = GetFileContents(File)
        ...
        For Each Line As String In PageContents
            ...
            ElseIf UpperLine.ToUpper.StartsWith("BOX") Then
            ...
            ElseIf UpperLine.ToUpper.StartsWith("CLOCK") Then
            ...
            ElseIf UpperLine.ToUpper.StartsWith("DATE") Then
            ...
            ElseIf UpperLine.ToUpper.StartsWith("CENTERTEXT") Then
                'Centers text on screen (Centertext~text~row)
                CurrentCommand = Line.Split("~")
                SetPos(0, CurrentCommand(2))
                CenterText(CurrentCommand(1))

            ElseIf UpperLine.ToUpper.StartsWith("WEATHERWINDOW") Then
            ...
            ElseIf UpperLine.ToUpper.StartsWith("NEWSWINDOW") Then
                'Draws a NewsWindow using a NewsWindow File (NEWSWIDNDOW File)
                CurrentCommand = Line.Split(" ")
                Dim NW As NewsWindow = New NewsWindow(CurrentCommand(1), CurrentCommand(2))
                NW.Render()
            ElseIf UpperLine.ToUpper.StartsWith("FLIGHTWINDOW") Then
                'Draws a FlightWindow using a Flightwindow file (FlightWindow, DepartureMode)
                CurrentCommand = Line.Split(" ")
                Dim FW As FlightWindow = New FlightWindow(CurrentCommand(1), CurrentCommand(2), CurrentCommand(3))
                FW.Render()
            Else
